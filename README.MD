  ...
  "PresetList": [
    {
      ...
      "PictureForceWidth": 0,
      "PresetName": "jellyfin-streaming-mkv",
      "Type": 1,
...
* This setup also uses `aws s3 sync` to back up your Jellyfin config every 6 hours.
